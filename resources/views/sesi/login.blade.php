        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="normal__breadcrumb__text">
              <h2>Login</h2>
              <p>Welcome to the official LiteRoom</p>
            </div>
          </div>
        </div>
      </div>
        ...
        @endif
              <form action="" method="post">
                ...
                <div class="input__item">
                  <input name="email" value="{{ Session::get('email') }}" type="text" placeholder="Email address" />
                ...
                <button name="submit" type="submit" class="site-btn">
                  <a href="" style="color: white">Login Now</a>
                </button>
              </form>
